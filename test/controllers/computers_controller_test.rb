...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { ip: @computer.ip, mac_address: @computer.mac_address, name: @computer.name, specification: @computer.specification, wtable_id: @computer.wtable_id, x: @computer.x, y: @computer.y } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { ip: @computer.ip, mac_address: @computer.mac_address, name: @computer.name, specification: @computer.specification, wtable_id: @computer.wtable_id, x: @computer.x, y: @computer.y } }
